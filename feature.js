...
function addGroundOverlay() {
    ...
    var historicalOverlay = new google.maps.GroundOverlay(
        'http://127.0.0.1:5500/images/denbigh.jpg',
        imageBounds);
...
function addGeoJSONDataLayer() {
    map.data.loadGeoJson('http://127.0.0.1:5500/data/SecretCastlesOfWales.json');

    map.data.setStyle({
        icon: 'http://127.0.0.1:5500/images/castle.png',
        strokeColor: 'green'
    });
}
